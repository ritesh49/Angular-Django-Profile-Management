...
export class RegisterComponent implements OnInit {  
  ...
  validate_inputs() {
    ...
    else if(this.regObj.email_id == undefined && /^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$/.test(this.regObj.email_id))
  ...
  register_user() {    
    ...
    else this.toaster.showInfo('Fill the Required Credentials before Registering');
  }  
